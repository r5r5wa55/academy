...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="row">
        <div class="col-lg-2 hade-show">รหัสการอบรม</div>
        <div class="col-lg-2 hade-show">ชื่อการอบรม</div>
        <div class="col-lg-2 hade-show">สถานที่จัดการอบรม</div>
        <div class="col-lg-2 hade-show">เจ้าของการอบรม</div>
        <div class="col-lg-2 hade-show">แก้ไขข้อมูล</div>
        <div class="col-lg-2 hade-show">ลบข้อมูล</div>
      </div>
      <?php foreach($trainings as $key=>$value): ?>
        <div class="row">
          <div class="col-lg-2 body-show"><?php echo $value['TRAINING_ID'];?></div>
          <div class="col-lg-2 body-show"><?php echo $value['TRAINING_TITLE'];?></div>
          <div class="col-lg-2 body-show"><?php echo $value['TRAINING_PLACE'];?></div>
          <div class="col-lg-2 body-show"><?php echo $value['PERSONNEL_NAME'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $value['PERSONNEL_SURNAME'];?></div>
           

          <div class="col-lg-2 body-show">
            <button type="button" class="btn btn-block btn-success" onclick="main.get_edit_trainings(
          ...
          <div class="col-lg-2 body-show">
            <button type="button" class="btn btn-block btn-danger" onclick="main.delete_trainings('<?php echo $value['TRAINING_ID'];?>')">ลบข้อมูล</button>
        </div>
      </div>
      <?php endforeach; ?>
      <div class="row">
        <div class="col-lg-4"></div>
        <div class="col-lg-4"> <button type="button" class="btn btn-block btn-outline-primary btn-lg m-3 p-3" onclick="$('#add_trainings').modal('show');">เพิ่มข้อมูล</button></div>
