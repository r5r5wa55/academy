  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 hade-show">ชั่วโมงในการเข้าร่วม</div>
      ...
      <?php foreach($service_participants as $key=>$value): ?>
        <div class="row">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 body-show"><?php echo $value['TOTAL_HOUR_SERVICE_P'];?></div>
