  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 box-btn-center">
          <a href="javascript:void(0)" class="box-btn-add" onclick="$('#add_counseling_types').modal('show');">
            เพิ่มข้อมูล
          </a>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-2"></div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 hade-show">ประเภท</div>
      ...
      <?php foreach($counseling_types as $key=>$value): ?>
        <div class="row">
        <div class="col-lg-2 "></div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show"><?php echo $value['COUNSELING_TYPE_ID'];?></div>
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-edit" onclick="main.get_edit_counseling_types(
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-delete" onclick="main.delete_counseling_types(
              '<?php echo $value['COUNSELING_TYPE_ID'];?>');">
              ลบข้อมูล
            </a>
          </div>
