  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" >หมวดหมู่กิจกรรม</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 box-btn-center">
          <a href="javascript:void(0)" class="box-btn-add" onclick="$('#add_activity_categories').modal('show');">
          เพิ่มข้อมูล
          </a>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-2"></div> 
      ...
      <?php foreach($activity_categories as $key=>$value): ?>
        <div class="row">
        <div class="col-lg-2 "></div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show"><?php echo $value['ACTIVITY_CATEGORY_ID'];?></div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show"><?php echo $value['ACTIVITY_CATEGORY_NAME'];?></div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-edit" onclick="main.get_edit_activity_categories(
              '<?php echo $value['ACTIVITY_CATEGORY_ID'];?>',
              '<?php echo $value['ACTIVITY_CATEGORY_NAME'];?>');">
              แก้ไขข้อมูล
            </a>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-delete" onclick="main.delete_activity_categories(
              '<?php echo $value['ACTIVITY_CATEGORY_ID'];?>');">
              ลบข้อมูล
            </a>
             <div class="col-lg-2 "></div>
