    ...
    <div class="content">
      <div class="row"> 
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 box-btn-center">
          <a href="javascript:void(0)" class="box-btn-add" onclick="$('#add_academics').modal('show');">
            เพิ่มข้อมูล
          </a>
        </div>
        <div class="col-lg-2 "></div>
      ...
      <?php foreach($academics as $key=>$value): ?>
        <div class="row">
          <div class="col-lg-2 "></div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show"><?php echo $value['ACADEMIC_ID'];?></div>
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-edit" onclick="main.get_data_edit(
              '<?php echo $value['ACADEMIC_ID'];?>',
              '<?php echo $value['ACADEMIC_NAME'];?>');">
              แก้ไขข้อมูล
            </a>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            <a href="javascript:void(0)" class="btn-delete" onclick="main.delete_academics(
              '<?php echo $value['ACADEMIC_ID'];?>');">
              ลบข้อมูล
            </a>
          </div>
