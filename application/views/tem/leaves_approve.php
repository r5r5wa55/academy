  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" >การอนุมัติการลา(เจ้าหน้าที่)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      ...
      <?php foreach($leaves as $key=>$value):?>
        <div class="row body-show-long">
          <div class="col-lg-3 col-md-3 col-sm-3 body-show box-btn-left text-long">
            <?php echo $value['PERSONNEL_ID'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <?php echo $value['PERSONNEL_NAME'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <?php echo $value['PERSONNEL_SURNAME'];?>
          </div>
         
          <div class="col-lg-3 col-md-3 col-sm-3 body-show box-btn-left text-long"><?php echo $value['LEAVE_TYPE'];?></div>
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 body-show box-btn-center">
            ...
            <?php endif; ?>
            <?php if ($value['CONFINED'] == '2' ||  $value['SUPERVISOR_STATUS'] != '0'): ?>
